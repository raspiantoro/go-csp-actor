module github.com/raspiantoro/go-actor

go 1.17

replace github.com/AsynkronIT/protoactor-go => github.com/asynkron/protoactor-go v0.0.0-20220223103931-0f5858b5a2b6

require github.com/AsynkronIT/protoactor-go v0.0.0-20220223103931-0f5858b5a2b6
